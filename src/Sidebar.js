      ...
      <div style={{minWidth: '16em'}} className="min-h-screen flex items-center justify-center bg-gray-100">
          <div className="flex w-full max-w-xs p-4 bg-gray-800 h-full">
              <ul className="flex flex-col w-full">
                  <li className="my-px">
                      <span className="flex font-medium text-sm text-gray-400 px-4 my-4 uppercase">Menu</span>
                  </li>
                  <li className="my-px">
                  ...
                  <li className="my-px">
                      <a href="/"
						...
						<span className="flex items-center justify-center text-lg text-gray-100">
                          ...
                          <span className="ml-3 text-gray-100">Record Video</span>
                      </a>
                  </li>
                  <li className="my-px">
                      <a href="/predict"
						...
						<span className="flex items-center justify-center text-lg text-gray-100">
                          ...
                          <span className="ml-3 text-gray-100">Predict</span>
                      </a>
                  </li>
                  <li className="my-px">
                      <a href="/demo"
						...
						<span className="flex items-center justify-center text-lg text-gray-100">
                          ...
                          <span className="ml-3 text-gray-100">Demo</span>
                      </a>
                  </li>
              </ul>
          </div>
